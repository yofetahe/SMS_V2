...
<body>
	...
	<div class="titleBottomBorder" style="background-color: #fff; height: 45px; padding-top: 6px; padding-left: 5px;">
		...
		<td>
			...
			<div class="form-group form-inline">
				<button type="submit" class="btn btn-default" onclick="studentFullYearExamResultListPerClassDetail('${loader}')"> SEARCH </button>				
			</div>
	...
	<div id="student_result_content" style="padding-top: 10px;">
