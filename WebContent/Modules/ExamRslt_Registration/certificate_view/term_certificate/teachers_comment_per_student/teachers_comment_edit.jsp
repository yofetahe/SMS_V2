		...
		<div class="panel panel-default" style="width: 500px;">
			...
			<div class="panel-body" align="left" style="padding-right: 30px;">
				...
				<div class="form-group form-inline">
					...
					<textarea id="tchrcomm" rows="5" cols="60" class="form-control">${teacherComment.erc_content}</textarea>
				</div>
										
				<button type="submit" class="btn btn-default" onclick="updateTeachersComment('${loader}', '${si_id}', '${cl_id}', '${cd_id}', '${at_id}', '${ac_year}', '${getTeacherComment[0].erc_id}')"> UPDATE </button>
