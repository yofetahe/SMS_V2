		...
		<table><tr>
			...
			<td>
				...
				<div id="examTypeList">
					...
					<select id="sub_id" class="form-control">
			...
			<td>
				...
				<button id="saveButton" type="submit" class="btn btn-default" onclick="generateQuarterMarkList('${loader}')"> GENERATE </button>
