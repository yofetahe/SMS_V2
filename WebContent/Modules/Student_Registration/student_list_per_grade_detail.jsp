...
<body>
	...
	<div class="titleBottomBorder" style="margin-bottom: 10px;">
		...
		<table><tr><td>
			<div style="color: #3d6e9f; cursor: pointer;" onclick="getStudentContactInformationListPerGrade('${loader}', '${studReg.clcdRelation.cl_id}', '${studReg.clcdRelation.cd_id}')">
				List Students Contact Information
			</div>
		</td><td width="80px">&nbsp;</td><td>
			<div style="color: #3d6e9f; cursor: pointer;" onclick="importStudentContactInfoFromExcelForm('${loader}', '${studReg.clcdRelation.cl_id}', '${studReg.clcdRelation.cd_id}')">
				Import Students Contact Information from Excel
			</div>
		</td></tr></table>
