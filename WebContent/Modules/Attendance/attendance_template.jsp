								...
								<td valign="top" style="padding-top: 0px;">
									...
									<div class="menu_shadow" style="height: 50px; padding: 10px; margin-bottom: 10px;">
										...
										<table><tr>
											...
											<td style="padding-left: 10px;"> <a href="/SMS/attendance/getAttendanceTemplate"><button id="studInformationBtn" type="submit" class="btn btn-default active"> Attendance Information </button></a> </td>
										</tr></table>
									...
									<div id="attendance_content"> 
										...
										<jsp:include page="attendance_list.jsp"/>
