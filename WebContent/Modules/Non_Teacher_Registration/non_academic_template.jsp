								...
								<td valign="top" style="padding-top: 0px">
									...
									<div class="menu_shadow" style="height: 50px; padding: 10px; margin-bottom: 10px;">
										...
										<table><tr>
											...
											<td style="padding-left: 10px;"> <a href="/SMS/nonteacher/getNonteacherTemplate"><button id="teacherInformationBtn" type="submit" class="btn btn-default active"> Non-Academic Stuff Information </button></a> </td>											
										</tr></table>
																				
									</div>
									
									<div id="non_teachers_content"> 
										
										<jsp:include page="nonteacher_list.jsp"/>
