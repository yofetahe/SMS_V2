						...
						<c:forEach varStatus="stat" var="grade_list" items="${class_list}">
							<tr>
								<td align="center" onmouseover="this.style.color = '#3d6e9f'" onmouseout="this.style.color = '#000000'">
									<c:set var="cl_id" value="${grade_list.cl_id}"/>
									<c:set var="class_name" value="${grade_list.class_name}"/>
									<div class="menu_button" id="${cl_id}" onclick="getClassDetailByClassIdForSpecialRegistration('${loader}', '${cl_id}', '${class_name}')">
