						...
						<s:iterator status="stat" value="traitList">
							<tr style="height: 40px;">
								...
								<td  style="text-align: center;">
									<s:div style="color: #3d6e9f; cursor: pointer;" onclick="traitGradeRel('%{#btid}', '%{#bt_title}')">Relate with Grade</s:div>
								</td>
								<td style="text-align: center;">
									<s:div style="color: #3d6e9f; cursor: pointer;" onclick="bevalTraitEditForm('%{#btid}')">Edit</s:div>
								</td>
							</tr>
						</s:iterator>
					</table>
